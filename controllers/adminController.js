...
exports.newPost_POST = [
  ...
  (req, res, next) => {
    ...
    if (!errors.isEmpty()) {
      ...
      fetch(`${apiUrl}/api/posts`, fetchDetails)
        .then((response) => response.json())
        .then((post) => {
...
exports.post_DELETE = (req, res, next) => {
  fetch(`${apiUrl}/api/posts/${req.params.id}`, { method: 'DELETE' })
    .then((response) => response.json())
    .then((post) => {
      res.redirect('/admin')
    }) 
...
exports.updatePost_POST = [
  ...
  (req, res, next) => {
    ...
    if (!errors.isEmpty()) {
      ...
      fetch(`${apiUrl}/api/posts/${req.params.id}`, fetchDetails)
        .then((response) => response.json())
        .then((updatedPost) => {
...
exports.comment_DELETE = (req, res, next) => {
  ...
  fetch(`${apiUrl}/api/posts/${req.params.id}/comments/${req.params.commentid}`, fetchDetails)
    .then((response) => response.json())
    .then((post) => {
